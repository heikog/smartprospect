...
import { Upload, FileSpreadsheet, FileText, Info, Download, Plus, Sparkles, Eye, MoreVertical, CheckCircle, Loader2, Send } from 'lucide-react';
...
export function CreateCampaign({ onCancel, onCreate, credits, onBuyCredits, campaigns, onSelectCampaign }: CreateCampaignProps) {
  ...
  const downloadExampleExcel = () => {
    // In der echten Implementierung würde hier eine Beispiel-Excel heruntergeladen
  ...
  const handleApproveCampaign = () => {
    if (campaignToReview) {
      ...
      // Hier würde in der echten Implementierung der Status aktualisiert werden
    }
  };
    ...
    <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
                ...
                {excelFile ? (
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Excel oder CSV mit Ihren Prospect-Daten
                    </p>
                  </div>
                )}
              </label>
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mb-3">
              Ihr Angebots- oder Informationsflyer, der personalisiert wird
            </p>
              ...
              <label htmlFor="pdf-upload" className="cursor-pointer">
                {pdfFile ? (
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Ihr Service- oder Produktflyer (max. 10 MB)
                    </p>
                  </div>
                )}
              </label>
      ...
      <Card className="p-8 mt-8">
        <div className="mb-6">
          ...
          <p className="text-slate-600">
            Übersicht über alle erstellten Kampagnen
          </p>
        </div>
                    ...
                    <TableCell className="text-center">
                      {campaign.status === 'draft' ? (
                        ...
                        <div className="flex flex-col items-center gap-1">
                          ...
                          <span className="text-xs text-slate-600">{campaign.progress}%</span>
                        </div>
                      ) : (
                        <div className="flex justify-center">
                          <CheckCircle className="w-5 h-5 text-green-600" />
