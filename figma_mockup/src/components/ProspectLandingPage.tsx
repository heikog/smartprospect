...
export function ProspectLandingPage({ open, onOpenChange, prospect }: ProspectLandingPageProps) {
  ...
  const toggleAudio = () => {
    ...
    // In echter Implementierung würde hier Audio abgespielt
  };
          ...
          <div className="px-12 py-10 max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                Smart Prospect ermöglicht es Ihnen, in wenigen Minuten vollständig personalisierte 
                B2B-Kampagnen zu erstellen. Erreichen Sie Ihre Zielkunden mit Avatar-Videos, 
                individualisierten Landingpages und professionellen Flyern – alles automatisch 
            ...
            <Card className="p-8 mb-12">
              <h3 className="text-2xl mb-4 text-slate-900">
                Ihre individuelle Präsentation
              </h3>
                  ...
                  <div className="bg-white rounded-lg shadow-2xl h-full p-8 flex flex-col">
                    ...
                    <div className="mt-4 flex justify-center gap-2">
                      {[...Array(5)].map((_, i) => (
                        <div 
                          key={i} 
                          className={`w-2 h-2 rounded-full ${i === 0 ? 'bg-blue-600' : 'bg-slate-300'}`}
                        />
                      ))}
                    </div>
                  </div>
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-sm text-slate-600 mt-3">
                  📊 Mit Gamma.app für Ihr Unternehmen erstellt
                </p>
              </div>
            </Card>
                ...
                <>
                  <div className="text-center mb-6">
                    ...
                    <p className="text-lg text-slate-700">
                      Interessiert an einer personalisierten Demo für Ihr Unternehmen in {prospect.stadt}? 
                      Hinterlassen Sie uns Ihre Kontaktdaten und wir melden uns innerhalb von 24 Stunden.
                    </p>
                  </div>
