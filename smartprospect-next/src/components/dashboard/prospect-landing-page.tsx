  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden p-0">
        <VisuallyHidden>
          <DialogTitle>
            Personalisierte Landingpage für {prospect.vorname} {prospect.nachname}
          </DialogTitle>
          <DialogDescription>
            Individuell erstellte Kampagnenseite mit Video, Präsentation und Audio-Content
          </DialogDescription>
        </VisuallyHidden>

        <button
          onClick={() => onOpenChange(false)}
          className="absolute right-4 top-4 z-50 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2"
        >
          <X className="h-4 w-4" />
          ...
          <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white px-12 py-16">
            <div className="max-w-4xl mx-auto space-y-4">
              <p className="text-sm uppercase tracking-widest text-blue-100">
                Personalisiert für {prospect.url.replace("https://", "")}
              </p>
              <h1 className="text-4xl font-semibold">
                {prospect.anrede === "Frau" ? "Liebe" : "Lieber"} {prospect.anrede} {prospect.nachname},
              </h1>
              <p className="text-xl text-blue-100 leading-relaxed">
                wir haben speziell für Sie und Ihr Unternehmen eine personalisierte Lösung entwickelt,
                die Ihre B2B-Vertriebsprozesse revolutionieren wird.
              </p>
            </div>
          </div>

          <div className="px-12 py-10 max-w-4xl mx-auto space-y-12">
            <section>
              <h2 className="text-3xl mb-4 text-slate-900">
                Automatisierte Multichannel-Kampagnen für {prospect.stadt}
              </h2>
              <p className="text-lg text-slate-700 leading-relaxed">
                Smart Prospect ermöglicht es Ihnen, in wenigen Minuten vollständig personalisierte B2B-Kampagnen zu erstellen.
                Erreichen Sie Ihre Zielkunden mit Avatar-Videos, individualisierten Landingpages und professionellen Flyern – alles automatisch generiert und auf Ihre Prospects zugeschnitten.
              </p>
            </section>
            ...
            <Card className="p-8 bg-slate-50">
              ...
              <p className="text-sm text-slate-600 mt-4 text-center">
                🎬 Personalisiertes Avatar-Video mit Heygen erstellt
              </p>
            </Card>
            ...
            <Card className="p-8 bg-gradient-to-br from-orange-50 to-amber-50">
              ...
              <p className="text-sm text-slate-600 mt-4 text-center">
                🎙️ Professionelle Audio-Nachricht mit ElevenLabs
              </p>
            </Card>
            ...
            <Card className="p-10 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
              {!submitted ? (
                <>
                  <div className="text-center mb-6">
                    ...
                    <p className="text-lg text-slate-700">
                      Interessiert an einer personalisierten Demo für Ihr Unternehmen in {prospect.stadt}? Hinterlassen Sie uns Ihre Kontaktdaten und wir melden uns innerhalb von 24 Stunden.
                    </p>
                  </div>
                ...
                <div className="text-center py-8 space-y-4">
                  ...
                  <h3 className="text-2xl text-slate-900">Vielen Dank, {prospect.vorname}!</h3>
                  <p className="text-lg text-slate-700">
            ...
            <div className="text-center mt-12 pt-8 border-t border-slate-200">
              ...
              <p className="text-xs text-slate-400 mt-2">
                Powered by Smart Prospect – Automatisierte B2B-Kampagnen
              </p>
            </div>
          </div>
        </div>
